...
Spina::Theme.register do |theme|
  ...
  theme.custom_pages = [
    {name: 'preparer_wavestone2', title: 'Preparer wavestone2', view_template: 'preparer_wavestone2'},
