...
Spina::Theme.register do |theme|
  ...
  theme.custom_pages = [
    {name: 'preparer_wavestone6.rb', title: 'Preparer wavestone6.rb', view_template: 'preparer_wavestone6.rb'},
