...
Spina::Theme.register do |theme|
  ...
  theme.custom_pages = [
    {name: 'preparer_spipSTAGING', title: 'Preparer spipSTAGING', view_template: 'preparer_spipSTAGING'},
