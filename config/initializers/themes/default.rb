...
Spina::Theme.register do |theme|
  ...
  theme.view_templates = [
    {name: 'preparer_spip_71_macon', title: 'Preparer spip_71_macon', parts: %w[main_title main_description zip_code_select direction_collapse_title direction_collapse_first_rich_content collapse_rich_content_good_practice direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse]},
