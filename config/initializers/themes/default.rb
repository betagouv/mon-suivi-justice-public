...
Spina::Theme.register do |theme|
  ...
  theme.custom_pages = [
    {name: 'preparer_wavestone7', title: 'Preparer wavestone7', view_template: 'preparer_wavestone7'},
