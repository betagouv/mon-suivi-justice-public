...
Spina::Theme.register do |theme|
  ...
  theme.view_templates = [
    ...
    {name: "preparer_spip92", title: "Préparer SPIP 92", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_spip28", title: "Préparer SPIP 28", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_sap_chartres", title: "Préparer SAP Chartres", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_sap_nanterre", title: "Préparer SAP Nanterre", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "qui_sommes_nous", title: "Qui sommes-nous", parts: %w[main_title main_rich_description button_text]},
    {name: "preparer_spip75", title: "Préparer SPIP 75", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_spip32", title: "Préparer SPIP 32", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_sap_paris", title: "Préparer SAP Paris", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_sap_angers", title: "Préparer SAP Angers", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_sap_thionville", title: "Préparer SAP Thionville", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_sap_mulhouse", title: "Préparer SAP Mulhouse", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_sap_reims", title: "Préparer SAP Reims", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
    {name: "preparer_spip49", title: "Préparer SPIP 49", parts: %w[main_title main_description direction_collapse_title direction_collapse_first_rich_content direction_collapse_second_rich_content direction_collapse_button_text direction_collapse_button_link rich_collapse zip_code_select]},
