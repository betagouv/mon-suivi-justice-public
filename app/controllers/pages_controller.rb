class PagesController < Spina::ApplicationController
  ...
  def preparer_spip74_bonneville
  end

  def preparer_spip01_bourg_en_bresse
  end

  def preparer_spip79_annemasse
  end

  def preparer_spip59_cambrai
  end

  def preparer_spip74_annemasse
  end

  def preparer_spip94
  end

  def preparer_sap_perigueux
  end

  def preparer_sap_carcassonne
  end

  def preparer_sap_valenciennes
  end

  def preparer_spip68_colmar
  end
  ...
  def preparer_spip62_bethune
  end

  def preparer_spip27_bernay
  end

  def preparer_sap_saint_brieuc
  end

  def preparer_sap_le_havre
  end

  def preparer_sap_creteil
  end

  def preparer_spip29_brest
  end

  def preparer_spip35_saint_malo
  end
  ...
  def preparer_spip35_rennes
  end

  def preparer_spip59_douai
  end
  ...
  def preparer_spip15_63_clermont_ferrand
  end

  def preparer_spip55_verdun
  end

  def preparer_spip80_amiens
  end

  def preparer_sap_cayenne
  end

  def preparer_spip34_montpellier
  end

  def preparer_spip64_bayonne
  end

  def preparer_spip64_pau
  end

  def preparer_spip72
  end

  def preparer_spip55_bar_le_duc
  end

  def preparer_spip73_chambery
  end

  def preparer_spip40_dax
  end

  def preparer_spip40_mont_de_marsan
  end
  ...
  def preparer_sap_vesoul
  end

  def preparer_spip73_albertville
  end

  def preparer_sap_dieppe
  end

  def preparer_sap_chambery
  end
  ...
  def preparer_sap_toulouse
  end

  def preparer_spip04
  end

  def preparer_sap_saint_denis
  end

  def preparer_sap_aix_en_provence
  end

  def preparer_sap_troyes
  end

  def preparer_sap_evreux
  end

  def preparer_sap_saint_nazaire
  end

  def preparer_sap_nimes
  end

  def preparer_sap_epinal
  end

  def preparer_sap_tulle
  end

  def preparer_sap_sarreguemines
  end

  def preparer_sap_bastia
  end

  def preparer_sap_saint_quentin
  end
