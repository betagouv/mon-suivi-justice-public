document.addEventListener("turbo:load", function(event) {
  ...
  if (placeCheckbox && placePictoClosed && placePictoOpened) {
  ...
  if (noShowCheckbox && noShowPictoClosed && noShowPictoOpened) {
  ...
  if (justifCheckbox && justifPictoClosed && justifPictoOpened) {
  ...
  if (processCheckbox && processPictoClosed && processPictoOpened) {
  ...
  if (lawyerCheckbox && lawyerPictoClosed && lawyerPictoOpened) {
